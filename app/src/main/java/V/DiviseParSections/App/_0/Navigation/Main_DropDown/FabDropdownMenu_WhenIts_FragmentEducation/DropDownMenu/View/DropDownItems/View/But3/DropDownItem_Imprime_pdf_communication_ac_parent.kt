...
import V.DiviseParSections.App._0.Navigation.Main_DropDown.FabDropdownMenu_WhenIts_FragmentEducation.DropDownMenu.View.DropDownItems.View.But2.ParentCommunicationCardData
import V.DiviseParSections.App._0.Navigation.Main_DropDown.FabDropdownMenu_WhenIts_FragmentEducation.DropDownMenu.View.DropDownItems.View.But2.PdfSaverUtility
import V.DiviseParSections.App._0.Navigation.Main_DropDown.FabDropdownMenu_WhenIts_FragmentEducation.DropDownMenu.View.DropDownItems.View.But2.generatePdfDocument
...
@Composable
fun DropDownItem_Imprime_pdf_caseAcoche_tikrare(
    ...
    fun createAndOpenPdfDocument() {
        ...
        scope.launch {
            try {
                ...
                val cardData = ParentCommunicationCardData.Companion.fromEtudiant(targetedEtudiant)
