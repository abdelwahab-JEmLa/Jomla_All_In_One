package V.DiviseParSections.App.SectionID10.PresenterElectroBoutiqueAbdelwahab.App.FragID1.Main.Fragment.View.C.Main.Ui.A.View.Expanded_Multi_Couleurs.View.L.View

import V.DiviseParSections.App.SectionID10.PresenterElectroBoutiqueAbdelwahab.App.FragID1.Main.Fragment.View.C.Main.Ui.A.View.Expanded_Multi_Couleurs.View.L.View.Functions.DepotUpdateResult
import V.DiviseParSections.App.SectionID10.PresenterElectroBoutiqueAbdelwahab.App.FragID1.Main.Fragment.View.C.Main.Ui.A.View.Expanded_Multi_Couleurs.View.L.View.Functions.lenceVent
        ...
        text = {
            Text(
                text = buildString {
                    ...
                    append("\n")
                    append("Quantité demandée: ${kotlin.math.abs(alertInfo.requestedChange)}")
                }
            )
        },
        confirmButton = {
