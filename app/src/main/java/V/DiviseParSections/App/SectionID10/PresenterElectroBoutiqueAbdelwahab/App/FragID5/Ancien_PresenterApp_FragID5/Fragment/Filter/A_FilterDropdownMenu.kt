        ...
        LazyColumn(
            ...
            item {
                Row(
                    ...
                    TextButton(
                        onClick = {
                            onFilterChanged(FilterState_Facad_Boutique_FragId5())
                            onDismiss()
                        }
                    ) {
                        Text("Réinitialiser")
                        ...
                        onClick = {
                            onFilterChanged(
                                FilterState_Facad_Boutique_FragId5(
                                    ...
                                    produit_a_Une_Couleur_Ac_Image = FilterState_Facad_Boutique_FragId5.WhatDo.N_Affiche_Que_Lui
                                )
                            )
                        }
                    ) {
...
private fun ImageFilterDropdown(
    currentValue: FilterState_Facad_Boutique_FragId5.WhatDo,
    onValueChange: (FilterState_Facad_Boutique_FragId5.WhatDo) -> Unit
) {
        ...
        Row(
            ...
            Text(
                text = when (currentValue) {
                    FilterState_Facad_Boutique_FragId5.WhatDo.N_Affiche_Que_Lui -> "Afficher uniquement les produits avec images"
                    FilterState_Facad_Boutique_FragId5.WhatDo.Ne_Affiche_Aucune -> "Afficher uniquement les produits sans images"
                    FilterState_Facad_Boutique_FragId5.WhatDo.Ignore -> "Ignorer le filtre d'images"
                },
                style = MaterialTheme.typography.bodyMedium
            )
            Icon(
    ...
    DropdownMenu(
        ...
        DropdownMenuItem(
            ...
            onClick = {
                onValueChange(FilterState_Facad_Boutique_FragId5.WhatDo.N_Affiche_Que_Lui)
                expanded = false
            }
        )
        DropdownMenuItem(
            ...
            onClick = {
                onValueChange(FilterState_Facad_Boutique_FragId5.WhatDo.Ne_Affiche_Aucune)
                expanded = false
            }
        )
        DropdownMenuItem(
            ...
            onClick = {
                onValueChange(FilterState_Facad_Boutique_FragId5.WhatDo.Ignore)
                expanded = false
            }
        )
    }
