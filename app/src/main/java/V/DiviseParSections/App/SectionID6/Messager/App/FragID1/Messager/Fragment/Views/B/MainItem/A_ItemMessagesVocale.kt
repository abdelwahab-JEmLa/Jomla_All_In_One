...
fun B_ItemMessagesVocale(
    ...
    // FIXED: Determine if this message belongs to the active account
    val activeCurrent_M9AppCompt = aCentralFacade.focusedActiveValuesFacade.focusedValuesGetter.active_Current_M9AppCompt
    val relative_M9AppCompt = aCentralFacade.repositorysMainGetter.repo9AppCompt.datasValue.find {
        it.keyID == relative_D_EtateMessageVocale.parent_M9AppCompt_KeyID
    }
    ...
    // FIXED: Telegram-like message layout
    Box(
        modifier = Modifier
            .fillMaxWidth()
