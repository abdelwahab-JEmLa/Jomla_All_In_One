package V.DiviseParSections.App.SectionID12.GrossistAchat.App.FragID1.CommandeProduits.Fragment.View.B.List.Z.Main.VIEW.Z.List.Z.AcheteursDeCetteProduit.List
    ...
    Column(
        ...
        listGBonVentKeyID.forEach { gBonVentKeyID ->
            ...
            val achatQuantityDeCetteBonVent = viewModel.getter.fVentCouleurOperationRepository
                ...
                .find { it.parentGBonVentKeyId == gBonVentKeyID }
