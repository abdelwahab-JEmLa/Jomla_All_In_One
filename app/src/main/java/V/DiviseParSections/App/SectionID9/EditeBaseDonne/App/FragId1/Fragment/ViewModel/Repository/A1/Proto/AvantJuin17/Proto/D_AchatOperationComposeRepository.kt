...
import V.DiviseParSections.App.SectionID9.EditeBaseDonne.App.FragId1.Fragment.ViewModel.Repository.A1.Proto.Juin17.Proto.D_AchatOperation.Companion.compareEntre
...
@Stable
class D_AchatOperationComposeRepository(
    private val ancienRepo: D_AchatOperationRepository,
) {
    ...
    fun addOrUpdateData(data: D_AchatOperation) {
        ...
        val existingIndex = datasValue.indexOfFirst { ancien ->
            compareEntre(ancien = ancien, newData = dataAvecTigerUpdate)
        }
