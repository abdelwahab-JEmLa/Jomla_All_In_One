...
fun MarkerStatusDialog(
    ...
    val isClientInCommandMode = remember(clientId, uiState) {
        ...
        lastTransaction?.etateActuellementEst == TransactionCommercial.EtateActuellementEst.ON_MODE_COMMEND_ACTUELLEMENT
    }
                        ...
                        Card(
                            ...
                            Column(
                                ...
                                LazyVerticalGrid(
                                    ...
                                    item {
                                        TransactionCommercial.EtateActuellementEst.AVEC_MARCHANDISE
                                            .ButtonAutreEtates(
                                                uiState = uiState,
                                                viewModel = viewModel,
                                    ...
                                    item {
                                        CommandButton(
                                            ...
                                            uiState = uiState,
                                            etateActuellementEst1 = TransactionCommercial.EtateActuellementEst.ON_MODE_COMMEND_ACTUELLEMENT,
                                            clientId = clientId,
                                    ...
                                    item {
                                        TransactionCommercial.EtateActuellementEst.FERME
                                            .ButtonAutreEtates(
                                                uiState = uiState,
                                                viewModel = viewModel,
                                                clickedClient = clientId,
                                    ...
                                    item {
                                        TransactionCommercial.EtateActuellementEst.ACHETEUR_NON_DISPO
                                            .ButtonAutreEtates(
                                                uiState = uiState,
                                                viewModel = viewModel,
                                                clickedClient = clientId,
                                    ...
                                    uiState.activeCompt?.let { activeCompt ->
                                        if (activeCompt.vid == 2L) {
                                            item {
                                                TransactionCommercial.EtateActuellementEst.CIBLE_POUR_2
                                                    .ButtonAutreEtates(
                                                        uiState = uiState,
                                                        viewModel = viewModel,
                                                        clickedClient = clientId,
