...
open class ClientsMapFilterViewModel(
    ...
    private fun getStartOfDay(timestamp: Long): Long {
        ...
        calendar.upsert(Calendar.HOUR_OF_DAY, 0)
        calendar.upsert(Calendar.MINUTE, 0)
        calendar.upsert(Calendar.SECOND, 0)
        calendar.upsert(Calendar.MILLISECOND, 0)
    ...
    private fun getEndOfDay(timestamp: Long): Long {
        val calendar = Calendar.getInstance()
        calendar.timeInMillis = timestamp
        calendar.upsert(Calendar.HOUR_OF_DAY, 23)
        calendar.upsert(Calendar.MINUTE, 59)
        calendar.upsert(Calendar.SECOND, 59)
        calendar.upsert(Calendar.MILLISECOND, 999)
        return calendar.timeInMillis
    }
