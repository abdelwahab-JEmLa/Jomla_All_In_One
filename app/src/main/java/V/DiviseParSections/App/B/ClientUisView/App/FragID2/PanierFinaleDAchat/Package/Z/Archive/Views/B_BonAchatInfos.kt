...
import V.DiviseParSections.App.SectionID12.GrossistAchat.App.FragID1.Achats_Produits_Chez_Grossists.Fragment.A.ViewModel.Repository.M8BonVent
                ...
                IconButton(
                    onClick = {
                        coroutineScope.launch {
                            // First create add_New temporary product in the database
                            ...
                            _0_0_HeadSQLRepositorysrepositorysModel._2_1_ProduitsDataBase_Repository.addDataAndReturnItVID(tempProduct) { productId ->
                                ...
                                _0_0_HeadSQLRepositorysrepositorysModel.repositoryC2_ProduitAcheteOperation.addDataAndReturneItVID(produitOperation) { produitOperationId ->
                                    // Finally upsert add_New color operation with quantity 1
