...
@Composable
fun TransactionVent.EtateActuellementEst.ButtonAutreEtates(
    uiState: UiState,
    ...
    FilledTonalButton(
        onClick = {
            ...
            if (newEtate == TransactionVent.EtateActuellementEst.COMMANDE_LIVRAI
                || newEtate == TransactionVent.EtateActuellementEst.A_COMMANDE_CONFIRME
            ) {
...
fun upsertLenceAutresStatesRepoGroupedProtoAvanJuin3(
    ...
    if (existingBonAchat != null) {
        ...
        val newTransaction = TransactionVent(
