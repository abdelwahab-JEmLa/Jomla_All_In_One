...
fun FragId1But_3(
    ...
    ControlButton(
        onClick = {
            ...
            viewModel.auClickeCaUpdateClientPar = if ( viewModel.auClickeCaUpdateClientPar == B_ClientDataBaseProtoC.TypeDeSonMagasine.ATAYAT_MOUKASSARAT) {
        ...
        icon = if ( viewModel.auClickeCaUpdateClientPar == B_ClientDataBaseProtoC.TypeDeSonMagasine.ATAYAT_MOUKASSARAT) {
