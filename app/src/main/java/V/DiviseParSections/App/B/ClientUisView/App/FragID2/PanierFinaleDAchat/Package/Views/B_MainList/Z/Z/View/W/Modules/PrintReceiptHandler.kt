package V.DiviseParSections.App.B.ClientUisView.App.FragID2.PanierFinaleDAchat.Package.Views.B_MainList.Z.Z.View.W.Modules
    ...
    fun printReceipt(
        ...
        val printFunction = {
            ...
            products.forEach { product ->
                ...
                val totalQuantity = repositorysModel._1_1_CouleurAcheteOperation_Repository.modelDatasSnapList
                    .filter {
