...
fun get_Found_Or_Default_M8BonVent(
...
): Found_Or_Default_M8BonVent? {          // ← now returns nullable
    ...
    return Found_Or_Default_M8BonVent(found_M8, defaultEdited_M8BonVent)
}
