package V.DiviseParSections.App.SectionId7.PresentoirApplication.App.FragId1.Prix.Fragment.A.Test
...
class _PreviewProvider : PreviewParameterProvider<List<Produit>> {
    ...
    private fun createSampleData(): List<Produit> {
        return listOf(
                        ...
                        typesTarification = listOf(
                            Produit.Client.TypeTarification(
                                ...
                                PrixsCurrency = listOf(
                                    ...
                                    Produit.Client.TypeTarification.Prix(
                                        id = 2,
                                        timestamp = createTimestampss(3, 14, 30, 2025, 5), // Week ago
                                        valeur = 24.99
                                    )
                                )
                            ),
            ...
            Produit(
                id = 2,
                timestamp = createTimestampss(7, 14, 30, 2025, 5), // 3 days ago
                        ...
                        typesTarification = listOf(
                            ...
                            Produit.Client.TypeTarification(
                                ...
                                PrixsCurrency = listOf(
                                    Produit.Client.TypeTarification.Prix(
                                        id = 1,
                                        timestamp = createTimestampss(10, 1, 0, 2025, 5),
                                        valeur = 200.99
                                    ),
                                    Produit.Client.TypeTarification.Prix(
                                        id = 2,
                                        timestamp = createTimestampss(10, 2, 0, 2025, 5),
                                        valeur = 300.99
                                    )
                                )
                            )
            ...
            Produit(
                id = 3,
                timestamp = createTimestampss(10, 9, 15, 2025, 5),
                infos = Produit.ProduitInfos(nom = "Produit C"),
                cesStatuesMutable = Produit.CesStatuesMutable(),  // Added this
                clients = listOf(
                    Produit.Client(
                        id = 1,
                        timestamp = createTimestampss(10, 10, 0, 2025, 5),
                        infos = Produit.Client.ClientInfos(nom = "ClientAchteur Delta"),
                        cesStatuesMutable = Produit.Client.CesStatuesMutable(),  // Added this
                        typesTarification = listOf(
                            Produit.Client.TypeTarification(
                                id = 1,
                                timestamp = createTimestampss(10, 10, 30, 2025, 5),
                                infos = Produit.Client.TypeTarification.Infos(type = Produit.Client.TypeTarification.TypeTarificationEnum.ParBenifice),
                                PrixsCurrency = listOf(
                                    Produit.Client.TypeTarification.Prix(
                                        id = 10006,
                                        timestamp = createTimestampss(10, 11, 0, 2025, 5),
                                        valeur = 79.99
                                    )
                                )
                            )
                    ...
                    Produit.Client(
                        id = 2,
                        timestamp = createTimestampss(10, 12, 0, 2025, 5),
                        infos = Produit.Client.ClientInfos(nom = "ClientAchteur Epsilon"),
                        cesStatuesMutable = Produit.Client.CesStatuesMutable(),  // Added this
                        typesTarification = listOf(
                            Produit.Client.TypeTarification(
                                id = 1,
                                timestamp = createTimestampss(10, 12, 30, 2025, 5),
                                infos = Produit.Client.TypeTarification.Infos(type = Produit.Client.TypeTarification.TypeTarificationEnum.Historique),
                                PrixsCurrency = listOf(
                                    Produit.Client.TypeTarification.Prix(
                                        id = 1,
                                        timestamp = createTimestampss(10, 13, 0, 2025, 5),
                                        valeur = 59.99
                                    )
                                )
                            )
