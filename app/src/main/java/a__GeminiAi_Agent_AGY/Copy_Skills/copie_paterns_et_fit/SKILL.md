---
name: copie_paterns_et_fit
description: Automatically copies, adapts, and ports coding patterns, feature implementations, and fixes from the ClientJetPack codebase to the local project.
---

# Skill - Copy Coding Patterns to Light App (copie_paterns_et_fit)
...
## Trigger Phrases
- "copie_paterns_et_fit"
- "copie_patterns_et_fit"
- "t_copie_compos_et_fit"
- "t>copie_compos_et_fit"
- "copie_compos_et_fit"
- "t_c_client"
- "/copie_paterns_et_fit /improb"
...
- Utilisez `grep_search` pour chercher les commentaires `TODO` (ou `t_copie_compos_et_fit` ou `copie_paterns_et_fit`) **directement dans le code du projet source** `D:\AndroidStudioProjects\ClientJetPack`.
