...
fun FloatingSecureClickToggleFAB(
    ...
    // When affiche_Dialog_Fast_Affiche_Panie becomes true, start 17 second timer
    LaunchedEffect(activeCentralValues.affiche_Dialog_Fast_Affiche_Panie) {
        if (activeCentralValues.affiche_Dialog_Fast_Affiche_Panie && !isSecurityDisabled) {
            // Dialog opened - disable security for 17 seconds
    ...
    // When any check is toggled, reset timer to 17 seconds
    ...
    LaunchedEffect(
        ...
        // If security is currently disabled (allowing clicks), reset to 17 seconds
    ...
    Row(
        ...
        FloatingActionButton(
            ...
            onClick = {
                // Manual toggle also resets to 17 seconds when disabling security
                ...
                // If we just disabled security, reset timer to 17
                if (newState) {
                    timeRemaining = 17
                }
            },
