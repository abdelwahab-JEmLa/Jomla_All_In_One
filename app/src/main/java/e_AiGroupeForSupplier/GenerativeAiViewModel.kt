...
class GenerativeAiViewModel : ViewModel() {
    ...
    private val generativeAiViewModel = GenerativeModel(
        ...
        systemInstruction = content { text("Je vais décrire la logique de transformation entre les deux structures JSON :\n\nRegroupement par Article :\n\nLe premier JSON montre les commandes individuelles\nLe deuxième JSON regroupe les commandes par article en sommant les quantités\n\n\nFusion des Clients :\n\nQuand un même article est commandé par différents clients, leurs IDs sont concaténés avec une virgule\nExemple : \"Kinder Joy®\" est commandé par les clients \"1\" et \"3\", donc ClientSoldToItId devient \"1,3\"\n\n\nSommation des Quantités :\n\nLes quantités (color1SoldQuantity et color2SoldQuantity) sont additionnées pour chaque article\nExemple pour \"Kinder Joy®\" :\n\nClient 1 : color1SoldQuantity=1, color2SoldQuantity=1\nClient 3 : color1SoldQuantity=1, color2SoldQuantity=0\nTotal : color1SoldQuantity=2, color2SoldQuantity=1\n\n\n\n\nSimplification des Données :\n\nLe second JSON élimine certains champs comme :\n\ncolor1IdPicked et color2IdPicked\ndate\nconfirmed\n\n\n\n\nÉlimination des Doublons :\n\nLes articles identiques sont fusionnés en une seule entrée\nExemple : \"hnina\" apparaît deux fois dans le premier JSON (idArticle 3557 et 3558) et est regroupé en une seule entrée dans le second") },
