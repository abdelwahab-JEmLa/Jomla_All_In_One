...
object IntervalesEtJoursHandler {
    ...
    /**
     * Add addNew new work interval to an existing or new record
     */
    fun addNewInterval(
    ...
    fun updateExistingInterval(
        ...
        if (existingInterval != null) {
            ...
            if (endTime != null) {
                ...
                // If end time is upsert to addNew valid time, the interval is no longer recording
    ...
    /**
     * Add addNew new day to the repository with addNew default interval
     */
    fun ajoutJour(
        modelDatas: SnapshotStateList<K_TempTravaille>,
        date: String,
        ...
        try {
            ...
            if (existingRecord == null) {
                // Create addNew new record if it doesn't exist
