...
import Z_CodePartageEntreApps.DataBase.Juin3.Proto.B_ClientInfosProtoJuin3.Repository.Z.Archive.Proto.E._3_ClientsDataBase.Extension.Log._3_ClientsDataBaseRepositoryLogOperationsExtension
import Z_CodePartageEntreApps.DataBase.Juin3.Proto.B_ClientInfosProtoJuin3.Repository.Z.Archive.Proto.E._3_ClientsDataBase.Extension.Update._3_ClientsDataBaseRepositoryUpdatesOperationsExtension
...
class _3_ClientsDataBase_RepositoryImpl(
    ...
    override var modelDatasSnapList: SnapshotStateList<_3_ClientsDataBaseProtoE> =
        mutableStateListOf()
    ...
    override fun updateUnSeulData(data: _3_ClientsDataBaseProtoE) {
            ...
            if (!isFlowListenerActive.get()) {
                flowValueEventListener = object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        try {
                            val updatedList = mutableListOf<_3_ClientsDataBaseProtoE>()
                            for (dataSnapshot in snapshot.children) {
                                val data = dataSnapshot.getValue(_3_ClientsDataBaseProtoE::class.java)
                                data?.let {
                                    updatedList.add(it)
                                }
                            }
        ...
        try {
            ...
            viewModelScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val dataList = mutableListOf<_3_ClientsDataBaseProtoE>()
    ...
    override fun deleteUnSeulData(data: _3_ClientsDataBaseProtoE) {
        updatesOperations.deleteUnSeulData(data, repositoryScope, appDatabase, modelDatasSnapList)
    }

    override fun addData(data: _3_ClientsDataBaseProtoE) {
        updatesOperations.addData(data, repositoryScope, appDatabase, modelDatasSnapList)
    }

    override suspend fun updateMultiDatas(datas: SnapshotStateList<_3_ClientsDataBaseProtoE>) {
