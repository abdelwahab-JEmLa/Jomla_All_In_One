...
import Z_CodePartageEntreApps.DataBase.Juin3.Proto.B_ClientInfosProtoJuin3.Repository.Z.Archive.Proto.D.Repository.B_ClientsDataBaseRepositoryImpl
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                try {
                    ...
                    snapshot.children.forEach { dataSnapshot ->
                        try {
                            val data = B_ClientsDataBaseProtoD.syncData(dataSnapshot = dataSnapshot) as B_ClientsDataBaseProtoD
