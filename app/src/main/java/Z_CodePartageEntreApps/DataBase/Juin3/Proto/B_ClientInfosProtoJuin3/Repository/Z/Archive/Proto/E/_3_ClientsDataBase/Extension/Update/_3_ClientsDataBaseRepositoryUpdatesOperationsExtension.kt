package Z_CodePartageEntreApps.DataBase.Juin3.Proto.B_ClientInfosProtoJuin3.Repository.Z.Archive.Proto.E._3_ClientsDataBase.Extension.Update
...
class _3_ClientsDataBaseRepositoryUpdatesOperationsExtension(
    ...
    fun updateUnSeulData(
        data: _3_ClientsDataBaseProtoE,
        repositoryScope: CoroutineScope,
        appDatabase: AppDatabase,
        modelDatasSnapList: SnapshotStateList<_3_ClientsDataBaseProtoE>
    ) {
    ...
    private suspend fun firebaseUpdateData(data: _3_ClientsDataBaseProtoE) {
        try {
            _3_ClientsDataBase_Repository.sonDataBaseRef.child(data.vid.toString()).setValue(data).await()
        } catch (e: Exception) {
    ...
    suspend fun updateMultiDatas(
        datas: SnapshotStateList<_3_ClientsDataBaseProtoE>,
    ...
    private fun batchFireBaseSet(datas: List<_3_ClientsDataBaseProtoE>) {
        try {
