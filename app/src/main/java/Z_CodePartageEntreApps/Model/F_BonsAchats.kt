...
interface J_AppInstalleDonTelephoneRepository {
    ...
    suspend fun onDataBaseChangeListnerAndLoad(): Pair<MainList<J_AppInstalleDonTelephone>, Flow<Float>>
...
class J_AppInstalleDonTelephoneRepositoryImpl : J_AppInstalleDonTelephoneRepository {
    ...
    override suspend fun onDataBaseChangeListnerAndLoad(): Pair<MainList<J_AppInstalleDonTelephone>, Flow<Float>> {
