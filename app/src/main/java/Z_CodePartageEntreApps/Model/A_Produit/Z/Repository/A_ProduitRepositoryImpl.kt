            ...
            if (!isFlowListenerActive.get()) {
                flowValueEventListener = object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        // If there are any items in the flow upsertLenceCommandeRepoGroupedProtoAvantJuin3 list, process them
                                ...
                                try {
                                    for (dataSnapshot in snapshot.children) {
                                        ...
                                        productId?.let { id ->
                                            ...
                                            // Remove this ID from the flow upsertLenceCommandeRepoGroupedProtoAvantJuin3 list after processing
                                            withContext(Dispatchers.IO) {
        ...
        try {
            ...
            withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    // Use the batch upsertLenceCommandeRepoGroupedProtoAvantJuin3 method instead of individual updates
