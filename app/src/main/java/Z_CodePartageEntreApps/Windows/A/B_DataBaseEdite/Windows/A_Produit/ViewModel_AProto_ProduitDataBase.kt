    ...
    fun populateModelearSonAncien() {
        ...
        viewModelScope.launch {
            try {
                ...
                // RepositorysMainGetter data from old database structure
                ...
                ancienDataList.forEachIndexed { index, ancienData ->
                    try {
                        ...
                        // Return add_New default item to maintain consistency
                ...
                // Create add_New SnapshotStateList from the converted data
                ...
                _2_1_ProduitsDataBase_Repository.addMultiDATAsEtReturnVIDsList(convertedData) { vids ->
                    ...
                    vids.forEachIndexed { index, vid ->
                        if (index < snapshotList.size) {
                            ...
                            Log.w(TAG, "Cannot upsertLenceCommandeRepoGroupedProtoAvantJuin3 A_Produit with index $index - index out of bounds")
                        }
                    }
                    ...
                    viewModelScope.launch {
                        try {
                            Log.d(TAG, "Starting upsertLenceCommandeRepoGroupedProtoAvantJuin3 of ${snapshotList.size} products in A_ProduitRepository")
