...
import V.DiviseParSections.App.B.ClientUisView.App.FragID2.PanierFinaleDAchat.Fragment.Z.Archive.ViewModel.PanierFinaleDAchatViewModel
...
val dataBaseProtoAvantJuin3Module = module {
    ...
    single { DataBaseFactory_B1CouleurOuGoutProduitDataBase(get<AppDatabase>().B1CouleurOuGoutProduitDataBaseDao()) }
