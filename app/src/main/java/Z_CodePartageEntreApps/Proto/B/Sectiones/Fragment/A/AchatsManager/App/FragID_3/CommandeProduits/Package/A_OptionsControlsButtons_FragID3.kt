...
private const val TAG = "A_OptionsControlsButtons_Main"

@Composable
fun A_OptionsControlsButtons_FragID3(viewModel: ViewModelFragment_APP2_ID_3) {
                ...
                if (showMenu) {
                    Row(
                        ...
                        FloatingActionButton(
                            ...
                            Icon(
                                Icons.Filled.Add,
                                contentDescription = "Group purchases by color"
                            )
                        }
                        ...
                        if (showLabels) {
                            Text(
                                ...
                                modifier = Modifier
                                    .background(
                                        if (uiState.isDataLoading) Color(0xFF2196F3) else Color(0xFF4CAF50)
                                    )
                                    .padding(4.dp),
                                color = Color.White
                            )
...
fun MenuButton(
    ...
    ControlButton(
        ...
        showLabels = showLabels,
        labelText = if (showMenu) "Hide" else "Achats Options",
        containerColor = Color(0xFF3F51B5)
    )
}
