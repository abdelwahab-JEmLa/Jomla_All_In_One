...
@Composable
fun _4_ColorDetails(colorDetails: List<_1_1_CouleurAcheteOperation>) {
    // Sort colors by ID for consistent display
    val sortedColorDetails = colorDetails.sortedBy { it.couleurId }

    sortedColorDetails.forEach { colorOp ->
        Row(
            modifier = Modifier
                .fillMaxWidth()
            ...
            Text(
                text = "Couleur #${colorOp.couleurId}",
