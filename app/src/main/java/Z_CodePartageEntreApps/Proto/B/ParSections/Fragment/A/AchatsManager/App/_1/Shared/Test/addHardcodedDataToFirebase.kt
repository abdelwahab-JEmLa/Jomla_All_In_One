package Z_CodePartageEntreApps.Proto.B.ParSections.Fragment.A.AchatsManager.App._1.Shared.Test
...
suspend fun addHardcodedDataToFirebase(
    ...
    try {
        ...
        // Create C3_BonAchate test data with relations to _1_4_PeriodeVent
        ...
        // Create _1_2_ProduitAcheteOperation test data with relations to C3_BonAchate
        ...
        if (active) {
            ...
            // Then C3_BonAchate (depends on _1_4_PeriodeVent)
            withContext(Dispatchers.IO) {
                val snapListBonAchat = mutableStateListOf<C3_BonAchate>()
            ...
            // Then _1_2_ProduitAcheteOperation (depends on C3_BonAchate)
            withContext(Dispatchers.IO) {
