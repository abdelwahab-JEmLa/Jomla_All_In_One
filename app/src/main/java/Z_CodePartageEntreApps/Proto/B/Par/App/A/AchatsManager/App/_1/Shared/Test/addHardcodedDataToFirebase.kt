package Z_CodePartageEntreApps.Proto.B.Par.App.A.AchatsManager.App._1.Shared.Test
    ...
    try {
        ...
        val produitTestData = listOf(
            ...
            _1_2_ProduitAcheteOperation(
                ...
                etateActuellementEst = _1_2_ProduitAcheteOperation.Etate.NON_CONFIRME_JUST_AFFICHE
            ),
            _1_2_ProduitAcheteOperation(
                vid = 202L,
                produitAcheterID = 1002L,
                parent_1_3_BonAchat = 501L,
                etateActuellementEst = _1_2_ProduitAcheteOperation.Etate.AFFICHE_MAIS_PAS_CONFIRME
            ),
            _1_2_ProduitAcheteOperation(
                vid = 203L,
            ...
            _1_2_ProduitAcheteOperation(
                ...
                parent_1_3_BonAchat = 503L,
                etateActuellementEst = _1_2_ProduitAcheteOperation.Etate.SUPPRIME_AU_PREMIER_PICK
            ),
            _1_2_ProduitAcheteOperation(
                vid = 207L,
            ...
            _1_2_ProduitAcheteOperation(
                ...
                etateActuellementEst = _1_2_ProduitAcheteOperation.Etate.SUPP_AU_PANIER_FINALE
            ),
            _1_2_ProduitAcheteOperation(
                vid = 209L,
        ...
        val couleurTestData = listOf(
            ...
            _1_1_CouleurAcheteOperation(
                ...
                totaleQuantity = 35,
                etateActuellementEst = _1_1_CouleurAcheteOperation.Etate.AFFICHE_MAIS_PAS_CONFIRME
            ),
            _1_1_CouleurAcheteOperation(
                vid = 6L,
                couleurId = 106L,
                parent_1_2_ProduitAcheteOperationID = 204L,
                totaleQuantity = 45,
                etateActuellementEst = _1_1_CouleurAcheteOperation.Etate.NON_CONFIRME_JUST_AFFICHE
            ),
            _1_1_CouleurAcheteOperation(
                vid = 7L,
                couleurId = 107L,
            ...
            _1_1_CouleurAcheteOperation(
                ...
                totaleQuantity = 20,
                etateActuellementEst = _1_1_CouleurAcheteOperation.Etate.SUPPRIME_AU_PREMIER_PICK
            ),
            _1_1_CouleurAcheteOperation(
                vid = 9L,
                couleurId = 109L,
            ...
            _1_1_CouleurAcheteOperation(
                ...
                totaleQuantity = 15,
                etateActuellementEst = _1_1_CouleurAcheteOperation.Etate.SUPP_AU_PANIER_FINALE
            ),
            _1_1_CouleurAcheteOperation(
                vid = 11L,
                couleurId = 111L,
