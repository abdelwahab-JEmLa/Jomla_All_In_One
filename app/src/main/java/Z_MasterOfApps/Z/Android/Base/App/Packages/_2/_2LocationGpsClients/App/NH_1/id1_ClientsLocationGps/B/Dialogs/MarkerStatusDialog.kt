package Z_MasterOfApps.Z.Android.Base.App.Packages._2._2LocationGpsClients.App.NH_1.id1_ClientsLocationGps.B.Dialogs

import Z_MasterOfApps.Kotlin.Model.ClientsDataBase
import Z_MasterOfApps.Kotlin.ViewModel.ViewModelInitApp
import Z_MasterOfApps.Z.Android.Base.App.Packages._2._2LocationGpsClients.App.NH_1.id1_ClientsLocationGps.ViewModel.Extension.Utils.updateLongAppSetting
            ...
            Column(
                ...
                StatusButton(
                    ...
                    color = Color(
                        ContextCompat.getColor(
                            context,
                            ClientsDataBase.GpsLocation.DernierEtatAAffiche.ON_MODE_COMMEND_ACTUELLEMENT.color
                        )
                    ),
                    onClick = {
                ...
                StatusButton(
                    ...
                    color = Color(
                        ContextCompat.getColor(
                            context,
                            ClientsDataBase.GpsLocation.DernierEtatAAffiche.CLIENT_ABSENT.color
                        )
                    ),
                    onClick = {
                        coroutineScope.launch {
                ...
                StatusButton(
                    ...
                    color = Color(
                        ContextCompat.getColor(
                            context,
                            ClientsDataBase.GpsLocation.DernierEtatAAffiche.AVEC_MARCHANDISE.color
                        )
                    ),
                    onClick = {
                        coroutineScope.launch {
                ...
                StatusButton(
                    ...
                    color = Color(
                        ContextCompat.getColor(
                            context,
                            ClientsDataBase.GpsLocation.DernierEtatAAffiche.FERME.color
                        )
                    ),
                    onClick = {
                        coroutineScope.launch {
