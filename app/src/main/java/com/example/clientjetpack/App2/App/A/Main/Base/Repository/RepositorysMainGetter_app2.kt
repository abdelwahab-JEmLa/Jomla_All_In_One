...
class RepositorysMainGetter_app2(
    ...
    focusedvaluesgetterApp2: FocusedValuesGetter_app2
) {
    val repoScope = CoroutineScope(Dispatchers.IO)
    val loadingProgress: Float by derivedStateOf {
        focusedvaluesgetterApp2.active_Central_Values.mainInitDataBaseProgressEtate
    }
    ...
    private val _datas_M3CouleurProduitInfos = mutableStateOf<List<M3CouleurProduitInfos>>(emptyList())
    ...
    init {
        repoScope.launch {
            ...
            dao_M3CouleurProduitInfos.getAllFlow().collect { _datas_M3CouleurProduitInfos.value = it }
        }
    }
